...
| `M1-F5-A` | `READY / BACKEND FOUNDATION CURRENT-MAIN PASS / WEB ENTRY` / 项目总控 | 对话 / 书籍双入口、单书来源、范围 / 需求与任务工作区 | `M1-F5-A1` 后端基础已闭合；下一步先按 SPEC、DESIGN-WEB 与已确认参考形成桌面入口 DESIGN-READY 合同，再释放精确 `apps/web/src/**` 文件边界。已闭合 Mini handoff 不重复开发、不触碰 f312 现场 |
