...
| `M1-F2-BOOK-DETAIL-VISUAL` | `ACTIVE` / `/root/book_detail_visual` | `bdv1@c75f745`；仅 `apps/web/src/book-detail-{state,view}{,.test}.ts` 与 `book-detail.css` | 绑定参考 07 / 08 / 10 / shared 02；首个可运行 diff 后自验并冻结候选，不触碰 Settings / Conversation shared seam |
