...
| `M2-F0-A-SCREEN-ADAPT-ALL` | `ACTIVE / NINE CHECKPOINTS COMMITTED / DESIGN-READY / REVERIFY QUEUED` / UI/UX + `01a034e4-12d5-7b31-9104-4d7431c12110` | 既有 f312 任务顺序独占 `apps/miniapp/**` 六页、drawer、输入 / 键盘与底部面板；台账只读，既有 `project.config.json` / 锁文件 diff 禁止触碰 | `4fc422f`、`630c051`、`5e270b1`、`5e0188d`、flow-only `cdaa307`、PPT viewport `6aba8ef`、account evidence `36aeb28`、full-route font evidence `5d51c53` 与 conversation / drawer visual `598e34f` 是九个局部恢复点；非作者按 D-TEXT→Web→Mini 顺序执行，当前 Mini 未轮到。软件键盘仍未实显，正式山亭缺失。全路由终验前不合并 |
