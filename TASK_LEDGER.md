...
| 当前 Desktop main 预览 | `RUNNING / EVENT BASELINE 08ad2fc / QUOTA H3 PASS / RESPONDER CONTRACT + COMPOSITION CASE PASS / FREE CHAT NOT WIRED` | responder合同与显式fake / 默认fail-closed组合已进main并完成真实Chrome双模式Case；API已恢复默认无mode。DeepSeek仅确认供应商，模型 / Key / 计费pending，故用户仍不能把开发fake当自由聊天。 |
